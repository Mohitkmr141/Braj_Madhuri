const PRODUCT_DATA = {
  ...
  Categories: {
    ...
    description:
      "Selected seva essentials for Thakur ji, japa, pooja, and home mandir.",
    price: 250,
    originalPrice: 300,
    items: {
  ...
  "Hawan-Cups": {
    ...
    description:
      "Convenient hawan cups prepared for pooja, havan, and daily rituals.",
    price: 180,
    originalPrice: 240,
    items: {
      "Hawan Cups Box": {
  ...
  "5 Poshak": {
    ...
    description:
      "Premium 5 number poshak for Thakur ji daily and occasion wear.",
    price: 499,
    originalPrice: 699,
  },
  ...
  "Itra & Fragnances/Shri Ang Itra": {
    ...
    items: {
      "Kesar Chandan Itra": {
        ...
        description: "100% Natural Shri Ang Seva Itra",
        subheading: "Pure, natural fragrances specially crafted for Thakurji's divine seva.",
        price: 399,
        originalPrice: 579,
      },
      "Kesar Itra": {
