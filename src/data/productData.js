const PRODUCT_DATA = {
  Aggarbaties: {
    ...
    description: "Hand-rolled devotional agarbatti for daily pooja and mandir fragrance.",
    price: 120,
    originalPrice: 180,
    items: {
      "1774885384670": {
      ...
      "1774885796278": {
        ...
        description: "Calming lavender fragrance for meditation and evening aarti.",
      },
      "1774886252840": {
  ...
  Categories: {
    title: "Braj Madhuri Devotional Collection",
    description: "Selected seva essentials for Thakur ji, japa, pooja, and home mandir.",
    price: 250,
    originalPrice: 300,
    items: {
      "1774794760226": {
      ...
      "1775577629268": {
        title: "Thakur Ji Singhasan",
        description: "Traditional singhasan setup for home mandir presentation.",
      },
      "1775577639100": {
        title: "Thakur Ji Singhasan",
  ...
  "Floral-Scent": {
    ...
    description: "Floral room and mandir sprays inspired by Vrindavan fragrances.",
    price: 250,
    originalPrice: 300,
    items: {
      "1775071046573": {
        title: "Mogra Floral Spray",
        description: "Fresh mogra fragrance for home, mandir, and altar spaces.",
      },
      "1775071160642": {
        title: "Gulab Floral Spray",
        description: "Rose fragrance for pooja, festivals, and daily freshness.",
      },
      "1775071297000": {
      ...
      "1775071622285": {
        ...
        description: "Sweet bela fragrance for calm and refreshing surroundings.",
      },
      "1776147314503": {
  ...
  "Hawan-Cups": {
    title: "Ready-to-use Hawan Cups",
    description: "Convenient hawan cups prepared for pooja, havan, and daily rituals.",
    price: 180,
    originalPrice: 240,
    items: {
      "1775208737555": {
  ...
  "Incense-Dhoop-Sticks": {
    title: "Incense and Dhoop Sticks",
    description: "Premium incense, dhoop sticks, and devotional fragrances.",
    price: 120,
    originalPrice: 180,
    items: {
      "1774797127114": {
  ...
  "Premium-Chandan-Tilak": {
    title: "Premium Chandan Tilak",
    description: "Smooth chandan tilak paste for pooja, aarti, and daily seva.",
    price: 250,
    originalPrice: 300,
  },
  "Shank-for-Thakur-ji-Snan": {
    title: "Shank for Thakur Ji Snan",
    description: "Sacred shank for Thakur ji snan seva and pooja rituals.",
    price: 299,
    originalPrice: 399,
  },
  "Thakur-ji-Shriang": {
    title: "Thakur Ji Shringar Essentials",
    description: "Attars and shringar essentials for Thakur ji seva.",
    price: 249,
    originalPrice: 349,
    items: {
      "1774903070024": {
  ...
  Vastra: {
    ...
    items: {
      "1774901988443": {
        ...
        description: "Assorted attars for seva, gifting, and personal devotion.",
        price: 230,
      },
      "1774902605954": {
  ...
  "1-2 No Poshak": {
    title: "1-2 No Thakur Ji Poshak",
    description: "Handcrafted 1-2 number poshak for Thakur ji shringar.",
    price: 299,
    originalPrice: 450,
  },
  "2-3 No Poshak": {
    title: "2-3 No Thakur Ji Poshak",
    description: "Beautiful 2-3 number poshak for daily and festive seva.",
    price: 349,
    originalPrice: 499,
  },
  "3-4 No Poshak": {
    title: "3-4 No Thakur Ji Poshak",
    description: "Elegant 3-4 number poshak for Thakur ji shringar.",
    price: 399,
    originalPrice: 549,
  },
  "4 Poshak": {
    title: "4 No Thakur Ji Poshak",
    description: "Festive 4 number poshak for Thakur ji seva.",
    price: 449,
    originalPrice: 599,
  },
  "5 Poshak": {
    title: "5 No Thakur Ji Poshak",
    description: "Premium 5 number poshak for Thakur ji daily and occasion wear.",
    price: 499,
    originalPrice: 699,
  },
};
